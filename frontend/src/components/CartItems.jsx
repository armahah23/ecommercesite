            ...
            if (cartItems[e.id] > 0) {
              return (
                ...
                >
                  ...
                  <td>
                    <div className="pl-16 bold-22 cursor-pointer">
      ...
      <div className="flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]">
        <div className="flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-10">
              <h4 className="bold-20 capitalize">Enter your cupon code here:</h4>
              <div className="flexBetween pl-5 h-12 bg-primary rounded-full ring-1 ring-slate-900/10">
                <input type="text" placeholder="Cupon Code" className="bg-transparent border-none outline-none"/>
